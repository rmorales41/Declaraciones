...
from libreria.models import declaracion,cliente_proveedor_cliente_proveedor,Asignacion
...
def Declaracion_General(request): 
    ...
    # busca y verifica si existe 
    file_path = os.path.join(ubicacion, archivo)
    # Verificar si el archivo ya existe y eliminarlo si es necesario
    if os.path.exists(file_path):
        os.remove(file_path)
    
    # Define la ruta completa donde se guardará el archivo
    save_path = os.path.join(ubicacion, archivo)  
          
    # busca las declaraciones 
